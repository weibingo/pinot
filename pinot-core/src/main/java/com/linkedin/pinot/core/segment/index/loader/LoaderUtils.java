...
public class LoaderUtils {
  ...
  /**
   * Try to recover a segment from reload failure (reloadSegment() method in HelixInstanceDataManager), no effect for
   * normal segments.
   ...
   *     <p>Both index directory and segment backup directory exist. Index directory could be left in corrupted state
   *     because we tried to load segment from it and potentially added indexes. Need to recover index directory from
   *     segment backup directory.
   *   </li>
   *   <li>
